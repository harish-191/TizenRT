 ...
 * @param is success result of reset.(1 : success, 0 : failure)
 */
 ...
 * the device information,resources and their properties, configuration info for
 * connectivity and easy-setup, etc.
